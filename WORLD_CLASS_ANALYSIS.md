# 🚀 Neon Voyager — World-Class App Roadmap
...
- [x] **P0-2 · Set up GCP project + Terraform scaffold**
  ...
  - Create GCP project (`neonvoyager-dev`)
  - Enable billing, create Terraform state bucket (`gs://neonvoyager-terraform-state`)
...
- [x] **R-3 · Bundle ID & signing** — Configure `com.neonvoyager.app` for iOS + Android
