...
```bash
gcloud projects create neonvoyager-dev --name="Neon Voyager Dev"
gcloud config set project neonvoyager-dev
```
...
```bash
gsutil mb -l europe-west1 gs://neonvoyager-terraform-state
```
...
- [Secret Manager](https://console.cloud.google.com/security/secret-manager?project=neonvoyager-dev) for API keys
- [Artifact Registry](https://console.cloud.google.com/artifacts?project=neonvoyager-dev) for Docker proxies
- [Cloud Run](https://console.cloud.google.com/run?project=neonvoyager-dev) for your deployed API proxy
- [Firebase Console](https://console.firebase.google.com/project/neonvoyager-dev/overview) (Auth, Crashlytics, etc.)
- [Firestore Database](https://console.firebase.google.com/project/neonvoyager-dev/firestore)
- [Cloud Build configuration](https://console.cloud.google.com/cloud-build/triggers?project=neonvoyager-dev)
...
gcloud builds submit \
  --tag europe-west1-docker.pkg.dev/neonvoyager-dev/neonvoyager/api-proxy:latest
```
...
# → https://neonvoyager-api-proxy-dev-xxxx-ew.a.run.app
```
...
```bash
flutter build ios \
  --dart-define=PROXY_URL=https://neonvoyager-api-proxy-dev-xxxx-ew.a.run.app
```
